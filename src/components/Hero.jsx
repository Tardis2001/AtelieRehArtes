...
export default function Hero() {
    ...
    const opacitySection2 = useTransform(progressSection2, [0, 0.3], [0, 1]);
    ...
    useMotionValueEvent(progressSection1, "change", (latestValue) => {
        console.log("Section 1 Vertical Progress:", latestValue);
    });
    ...
    return (
        <section id="home" className="w-full flex justify-center items-center flex-col">
            ...
            <div ref={section2Ref} className="bg-slate-300 w-full h-[120vh] flex justify-end items-center overflow-hidden">
